  ...
  return (
    <>
      <div className="md:flex md:w-full md:mb-16 md:items-end md:justify-end">
        <div className="md:w-16 md:h-16 md:rounded-full md:border md: md:bottom-0 h-16 w-full flex justify-center items-center border-t border-gold-dark bg-homeGray-darker  fixed bottom-0 visible z-50 md:mb-2 md:mr-2">
